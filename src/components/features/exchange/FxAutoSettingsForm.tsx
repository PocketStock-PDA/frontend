...
export const RESIDUAL_CONVERT = "CONVERT_TO_KRW";
export const RESIDUAL_KEEP = "KEEP_AS_USD";

export const DEFAULT_FX_AUTO_SETTINGS: FxAutoSetting = {
  autoEnabled: false,
  useDollarFirst: true,
  maxAmountPerTx: null,
...
interface FxAutoSettingsFormProps {
...
/**
 * 자동환전 설정 폼 — /exchange/auto-settings 페이지와 만기 매수 예약(reserve) 시트에서 공용.
 * AppHeader·라우팅은 호출부가 책임지고, 이 컴포넌트는 폼 본문·저장만 담당한다.
 */
export function FxAutoSettingsForm({
  initialSettings,
  onSaved,
  submitLabel = "설정 저장",
